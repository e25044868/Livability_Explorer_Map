...
const messages = {
  'zh-TW': {
    ...
    searchPlaceholder: '搜尋地址、地標或設施', searchLoading: '搜尋中', noSearchResults: '找不到具可信座標的設施',
    addressUnavailable: '地址未提供', loadingPlaces: '正在查詢設施…', unableToLoad: '無法取得資料',
    noPlaces: '這個範圍目前沒有設施', tryMoveMap: '移動地圖或放大搜尋半徑再試一次。',
    sort: '排序', closest: '離我最近', availability: '剩餘車位', name: '名稱', carSpacesAtLeast: '汽車格至少',
    ...
    coolMap: '環境部 Cool map 涼適點', nationalShelter: '內政部消防署避難收容處所資料', nationalWifi: '數位發展部 iTaiwan 公共免費 Wi-Fi 資料', nationalRescue: '內政部消防署消防／救援據點資料', nationalPolice: '內政部警政署警察機關資料', governmentData: '政府開放資料',
    ...
    shelterSource: '內政部消防署：避難收容處所點位檔', wifiSource: '數位發展部：iTaiwan 公共區域免費無線上網熱點', rescueSource: '內政部消防署：消防／救援據點位置', policeSource: '內政部警政署：警察機關地址與座標資料', aboutNote: '資料會依各官方來源的公開更新情況整理發布；平台僅呈現具可信座標的項目，實際服務狀態請以主管機關公告為準。',
    parking: '路外停車場', toilet: '公共廁所', aed: 'AED', drinking_water: '公共飲水機', shelter: '避難收容處所', public_wifi: '公共免費 Wi-Fi', rescue_unit: '消防／救援據點', police: '警察機關／派出所', pharmacy: '藥局', medical: '醫療院所', motorcycle_charging: '機車充電',
  },
  en: {
    ...
    searchPlaceholder: 'Search an address, landmark, or facility', searchLoading: 'Searching', noSearchResults: 'No facility with verified coordinates found',
    ...
    sort: 'Sort', closest: 'Nearest', availability: 'Available spaces', name: 'Name', carSpacesAtLeast: 'Minimum car spaces',
    ...
    coolMap: 'MOENV Cool Map', nationalShelter: 'National Fire Agency shelter data', nationalWifi: 'MODA iTaiwan free public Wi-Fi data', nationalRescue: 'National Fire Agency fire and rescue unit data', nationalPolice: 'National Police Agency police facility data', governmentData: 'Government open data',
    ...
    shelterSource: 'National Fire Agency: Emergency shelter locations', wifiSource: 'MODA: iTaiwan public free Wi-Fi hotspots', rescueSource: 'National Fire Agency: Fire and rescue unit locations', policeSource: 'National Police Agency: Police facility addresses and coordinates', aboutNote: 'Data is organised according to each official source’s public updates. Only records with verified coordinates are plotted; always confirm service status with the responsible authority.',
    parking: 'Off-street parking', toilet: 'Public restroom', aed: 'AED', drinking_water: 'Drinking water', shelter: 'Emergency shelter', public_wifi: 'Free public Wi-Fi', rescue_unit: 'Fire and rescue unit', police: 'Police station', pharmacy: 'Pharmacy', medical: 'Medical facility', motorcycle_charging: 'Motorcycle charging',
  },
} as const
