...
const messages = {
  'zh-TW': {
    ...
    searchPlaceholder: '輸入完整地址、地標或設施', searchLoading: '搜尋中', noSearchResults: '找不到具可信座標的設施',
  ...
  en: {
    ...
    searchPlaceholder: 'Enter an address, landmark, or facility', searchLoading: 'Searching', noSearchResults: 'No facility with verified coordinates found',
