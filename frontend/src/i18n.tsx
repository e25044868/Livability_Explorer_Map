...
const messages = {
  'zh-TW': {
    ...
    withinRadius: '中心點 {radius} 內', cityData: '{city}資料', currentMapArea: '目前地圖區域',
  ...
  en: {
    ...
    withinRadius: 'Within {radius} of center', cityData: '{city} data', currentMapArea: 'Current map area',
